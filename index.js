...
let owners = '936307675401183352'//ايدي الي هيتحول 
let owner;
const
  updateAdmins = () => {
  owner = db.get("admins")
  owners = '936307675401183352'
  owner.unshift('936307675401183352')//اي دي حقك
}
updateAdmins()
...
client.on('guildCreate', guild => {
  ...
  let textList = ["QUSAI" , `${prefix}help` , "BY Anase Tony"] 
